#python main.py --track LA --lr 0.0001 --batch_size 32 --database_path "/your/path/to/data/ASVspoof_database/" --protocols_path "/your/path/to/protocols/ASVspoof_database/"
import argparse
import sys
import os
import numpy as np
...
if __name__ == '__main__':
    ...
    d_label_trn, file_train = genSpoof_list(dir_meta=os.path.join(args.protocols_path, 'ASVspoof2019.LA.cm.train.trn.txt'), is_train=True, is_eval=False)
    ...
    d_label_dev, file_dev = genSpoof_list(dir_meta=os.path.join(args.protocols_path, 'ASVspoof2019.LA.cm.dev.trl.txt'), is_train=False, is_eval=False)
